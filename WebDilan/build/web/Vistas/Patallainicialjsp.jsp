...
<html lang="en">
    <head>
        ...
        <link href="../Css/Pantallainiciocss.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <header>
            <nav class="navbar navbar-expand-lg navbar-light" id="partesuperior">
                <div class="container-fluid">
                    <a class="navbar-brand" href="/ArtesaniaWeb/CtrProducto?accion=pantalla"><b>DECO Artesanías</b></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="carrito.jsp"><img src="imagenes/carrito-de-compras.png" alt="Carrito" width="30px"></a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container my-5">
            ...
            <div class="row">
                <c:forEach var="pro" items="${productos}">
                    <div class="col-md-4">
                        <div class="card">
                            <img src="${pro.getFoto()}" class="card-img-top" alt="Producto 1">
                            <div class="card-body">
                                <h5 class="card-title">${pro.getNombre()}</h5>
                                <p class="card-text">${pro.getDescripcion()}</p>
                                <a href="#" class="btn btn-primary">${pro.Precio()}</a>
                            </div>
                        </div>
                    </c:forEach>
                </div>
